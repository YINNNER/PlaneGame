...
bool RepoLayer::init() {
	...
	_background_3_white->setPosition(Vec2(origin.x+winSize.width * 0.2, origin.y+winSize.height * 0.5));
	...
	_background_3_white = Sprite::create("res/UI/a6Repo/rectWhite.png");
	_background_3_white->setPosition(Vec2(origin.x+winSize.width * 0.2, origin.y+winSize.height * 0.3));
	_background_3_white->setScale(0.45);//缩放0.5倍
	this->addChild(_background_3_white);
	...
	_background_3_white = Sprite::create("res/UI/a6Repo/rectWhite.png");
	_background_3_white->setPosition(Vec2(origin.x+winSize.width * 0.2, origin.y+winSize.height * 0.1));
	_background_3_white->setScale(0.45);//缩放0.5倍
	this->addChild(_background_3_white);
	...
	changeEquip_1->setPosition(Vec2(origin.x+winSize.width *0.2, origin.y+winSize.height *0.5));
	...
	_equip_2->setPosition(Vec2(origin.x+winSize.width *0.2, origin.y+winSize.height *0.3));
	...
	changeEquip_3->setPosition(Vec2(origin.x+winSize.width *0.2, origin.y+winSize.height *0.1));
	...
	_equip_3->setPosition(Vec2(origin.x+winSize.width *0.2, origin.y+winSize.height *0.1));
	...
	life->setPosition(Vec2(origin.x+winSize.width * 0.6, origin.y+winSize.height * 0.8));
	this->addChild(life);



	Label *  energy = Label::createWithTTF("能量", "fonts/simhei.ttf", 15);
	energy->setPosition(Vec2(origin.x+winSize.width * 0.6, origin.y+winSize.height * 0.76));
	this->addChild(energy);

	Label *  attack = Label::createWithTTF("攻击", "fonts/simhei.ttf", 15);
	attack->setPosition(Vec2(origin.x+winSize.width * 0.6, origin.y+winSize.height * 0.72));
	this->addChild(attack);

	Label *  speed = Label::createWithTTF("速度", "fonts/simhei.ttf", 15);
	speed->setPosition(Vec2(origin.x+winSize.width * 0.6, origin.y+winSize.height * 0.68));
	this->addChild(speed);
	//装备栏
